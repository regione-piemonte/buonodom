...
******************************************************************************/
package it.csi.buonodom.buonodomstarda.interceptor.server;
...
import it.csi.buonodom.buonodomstarda.dto.custom.LogAudit;
import it.csi.buonodom.buonodomstarda.integration.service.LogAuditService;
	...
	public void filter(ContainerRequestContext requestContext) throws IOException {
		...
		try {
			...
			if (httpRequest.getHeader("X-Forwarded-For") == null)
				logaudit.setIpAddress("10.0.0.0");
			else
