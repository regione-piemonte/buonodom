...
export default {
  ...
  methods: {
    onInput(event) {
      // Facciamo questo giro perch̩ vogliamo restituire il tipo di dato corretto.
      // Es. se il value ̬ un intero, senza questo hack restituiremmo una stringa dal momento che
