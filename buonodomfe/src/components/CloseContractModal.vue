    ...
    <q-card style="max-width: 800px" v-if="contractModal">
      <q-card-section>
        <lms-banner type="warning">
          ...
          <p>
            Se confermi la chiusura, il contratto sarÃ  cancellato dalla data
        ...
        <p class="sr-only">
          Il tasto "comunica chiusura" Ã¨ bloccato finchÃ© non viene inserita la data di fine contratto, la quale deve essere successiva a quella di inzio contratto.
        </p>
        <div
        ...
        >
          ...
          <div class="col-8 col-lg-4">
            ...
            <p class="text--error" v-if="errorDataFine">
              La data di chiusura contratto non puÃ² essere inferiore alla data inizio
            </p>
          </div>
        </div>
