      ...
      <q-card-section>
        <lms-banner type="warning">
          <h2 class="text-center">
            ...
            DOMICILIARITÃâ ai sensi del D.P.R. 445/2000 art. 38
          </h2>
          <p>
            Il/a sottoscritto/a
            <strong
          ...
          <p v-if="typeModal == 'buono'">
            di voler rinunciare allâerogazione del âBuono DomiciliaritÃ â (D.G.R. n. 27-6320 del 22/12/2022) assegnato in favore del dichiarante ovvero in nome e per conto di  <strong
          ...
          <p v-else>
            ...
            relativa al âBuono DomiciliaritÃ â (D.G.R. nÂ°. 27-6320 del
            22/12/2022) sulla piattaforma dedicata e presentata in favore del
          ...
          <h3 class="text-center" >dichiara, inoltre, di prendere atto che:</h3>
          <p>lâinvio della presente dichiarazione non esclude la possibilitÃ  di rendicontare le mensilitÃ  pregresse.</p>
          </template>
