              ...
              <div class="row justify-end q-gutter-y-lg">
                <div class="col-auto">
                  <q-btn
                    ...
                    aria-label="se il pulsante non Ã¨ disabilitato si puÃ² procedere al salvataggio in bozza"
                    @click="salvaBozza()"
                ...
                <div class="col-auto">
                  <q-btn
                    ...
                    color="primary"
                    @click="avanti()"
                    aria-label="se il pulsante non Ã¨ disabilitato si puÃ² procedere allo step successivo"
                    label="AVANTI"
        ...
        <q-card style="max-width: 800px">
          <q-card-section>
            <lms-banner type="positive">
              <h2>
                La richiesta di buono domiciliaritÃ  Ã¨ stata inviata con successo
              </h2>
              <p>
        ...
        <q-card style="max-width: 800px">
          <q-card-section>
            <lms-banner type="negative">
              <h2>La richiesta di buono domiciliaritÃ  non Ã¨ stata inviata</h2>
    ...
    async salva() {
      ...
      try {
        ...
        if (attivi) {
          ...
          this.$q.notify({
            type: "negative",
            message: `Non Ã¨ possibile salvare non ci sono sportelli attivi, torna alla homepage per vedere quando sarÃ  possibile fare domanda`,
          });
        }
      } catch (err) {
        console.error(err);
