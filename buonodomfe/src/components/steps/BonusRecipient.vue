          ...
          <template v-if="stepperForm.show_destinatario">
            ...
            <div class="row q-mb-xl">
              <div class="col-12 col-lg-8 q-mr-sm">
                <label for="asl-select"> *Asl </label>
                <div>
                  <lms-select
                    id="asl-select"
            ...
            <div class="row q-mb-xl q-gutter-y-lg">
              <div class="col-12 col-lg-8 q-mr-sm">
                <label for="studio-select"> *Titolo studio </label>
                <lms-select
                  id="studio-select"
          ...
          >
            <div class="row q-mb-xl">
              <div class="col-12 col-lg-8 q-mr-sm">
                <label for="relazione-select">
                  *Richiedente opera in qualitÃ  di
                </label>
                <lms-select
                  id="relazione-select"
            ...
            <div class="row q-mb-xl">
              <div class="col-12 col-lg-8 q-mr-sm border-left--attach">
                <p>
                  Allegare la procura speciale (e la carta d'identitÃ  del
                  delegante) se il richiedente opera in qualitÃ  di:
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    parente in linea diretta di 1Â° grado (genitori-figli) non
                    convivente;
                  </li>
                  <li>curatela;</li>
            ...
            <div class="row q-mb-xl q-gutter-y-lg">
              <div class="col-12 col-lg-4 q-pa-xs" v-if="delegaAllowed">
                <h2><template v-if="delegaRequired">*</template>Delega</h2>
                <q-file
                  ref="DELEGA"
                  outlined
                  clearable
                ...
                <q-btn
                  ...
                  color="primary"
                  label="ALLEGA"
                  aria-label="Carica il documento di Delega"
                ></q-btn>
                <div v-if="allegati.DELEGA" class="q-my-lg">
                  <q-btn
                    ...
                    :aria-label="'elimina il documento' + allegati.DELEGA.name"
                  />
              ...
              <div class="col-12 col-lg-6 q-pa-xs" v-if="cartaIdentitaAllowed">
                ...
                <q-btn
                  ...
                  color="primary"
                  label="ALLEGA"
                  aria-label="carica il documento di carta d'identitÃ "
                ></q-btn>
