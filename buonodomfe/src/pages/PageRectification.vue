        ...
        <q-card-section>
          ...
          <div class="row q-mb-xl" v-if="richiesta.delega">
            <div v-if="check('delega')">
              <div>
                <strong>*Richiedente opera in qualitÃ  di</strong>
                <lms-select
                  id="relazione-select"
      ...
      <q-card class="q-mt-xl q-mb-xl">
              ...
              <div v-if="richiesta.valutazione_multidimensionale === 'UVG'">
                ...
                <div v-if="!precedente_VERBALE_UVG && !allegati.VERBALE_UVG">
                  ...
                  <h3 class="title-card--alert q-mb-xl">
                    ATTENZIONE: <u>NON ALLEGARE</u> il verbale di invaliditÃ 
        ...
        <q-card-section>
          ...
          <div class="row q-mb-xl q-gutter-y-lg">
            ...
            <div class="col-12 col-md-8">
              <div class="q-ma-xs">
                <q-input
                  :disable="!check('accredito.intestatario')"
                  outlined
                ...
                >
                  <template v-slot:error>
                    Campo intestatario iban obbligatorio
                  </template>
                </q-input>
              </div>
            </div>
        ...
        <q-card-section>
          ...
          <q-card-section class="q-my-xl">
            ...
            <div class="q-my-lg">
              <q-radio
                :disable="!check('contratto.tipo_supporto_familiare')"
                dense
            ...
            <q-radio
              :disable="!check('contratto.tipo_supporto_familiare') || legalAge"
              dense
              v-model="richiesta.contratto.tipo_supporto_familiare"
          ...
          <q-card-section v-if="richiesta.contratto.tipo_supporto_familiare">
            ...
            <q-radio
              ...
              "
              :disable="
                !check('contratto.tipo') &&
                !check('contratto.tipo_supporto_familiare')
              "
              dense
              ...
              <div class="border-left--primary">
                ...
                >
                  <div class="row">
                    <div class="col-12 col-lg-8">
                      ...
                      <lms-select
                        :disable="
                          !check('contratto.relazione_destinatario') &&
                          !check('contratto.tipo') &&
                          !check('contratto.tipo_supporto_familiare')
                        "
                        id="relazione-select"
                ...
                <div class="q-my-xl">
                  ...
                  <CheckCF
                    ...
                    @verificaCF="verificaCF($event)"
                    v-if="
                      check('contratto.assistente_familiare') ||
                      check('contratto.tipo') ||
                      check('contratto.tipo_supporto_familiare')
                    "
                  />
                ...
                <template v-if="stepperForm.show_assistente_familiare == false">
                  ...
                  <div class="row q-my-xl q-gutter-y-lg">
                    ...
                    <div class="col-12">
                      <h3>
                        *Copia denuncia rapporto di lavoro domestico presentata
                        a INPS
                      </h3>
                  ...
                  <div class="row q-mb-md">
                    <div class="col-12 col-sm-9 col-lg-5">
                      <q-input
                        outlined
                        :disable="
                          !check('contratto.piva_assitente_familiare') &&
                          !check('contratto.tipo') &&
                          !check('contratto.tipo_supporto_familiare')
                        "
...
export default {
  ...
  async created() {
    ...
    try {
      ...
      // VERIFICA L'ENCO DEI CAMPI DA RETTIFICARE
      if (data["rettificare"]) {
