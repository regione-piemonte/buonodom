...
/**
 * Verifica se l'utente ̬ minore dal cf (attualmente questo controllo include anche gli ultracentenari)
 *
 * @param taxcode cf del utente
 * @returns {boolean} true se ̬ minorenne
 */
export const getUserMinor = (taxCode) =>{

  // Se il codice fiscale ̬ numerico viene considerato un maggiorenne
