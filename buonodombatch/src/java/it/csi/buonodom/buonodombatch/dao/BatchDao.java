...
public class BatchDao {
	...
	public static final String SELECT_BATCH_PARAMETRO = "SELECT batchparam_valore "
			...
			+ "and b.batchgruppo_id=c.batchgruppo_id " + "and c.batchgruppo_cod='BATCH'";
	...
	public static final String SELECT_ESISTE_RECORD_AVVIATO_KO = "select batchesec_id from bdom_t_batch_esecuzione a, bdom_d_batch_stato b,"
			...
			+ "and d.batchgruppo_id =c.batchgruppo_id " + "and d.batchgruppo_cod ='BATCH' " + "and a.sportello_id = ? "
			+ "and a.domanda_id = ? " + "and a.domanda_det_id = ? " + "and a.data_cancellazione is null "
			+ "and b.validita_inizio  <= now() " + "and b.validita_fine is null " + "and c.batch_cod = ? "
