...
import it.csi.buonodom.buonodomsrv.dto.ModelGetAllegato;
...
import it.csi.buonodom.buonodomsrv.integration.dao.utils.AllegatoExtMapper;
import it.csi.buonodom.buonodomsrv.integration.dao.utils.AllegatoGetMapper;
import it.csi.buonodom.buonodomsrv.integration.dao.utils.DettaglioRichiestaMapper;
import it.csi.buonodom.buonodomsrv.integration.dao.utils.DettaglioRichiestaRecuperoMapper;
import it.csi.buonodom.buonodomsrv.integration.dao.utils.IncompatibilitaMapper;
...
public class RichiesteDao extends LoggerUtil {
	...
	public static final String UPDATE_DOMANDA_ALLEGATO = "UPDATE bdom_t_allegato a "
			...
			+ "from bdom_t_domanda_dettaglio b, bdom_d_allegato_tipo c "
	...
	public static final String INSERT_DOMANDA_ALLEGATO = "INSERT INTO bdom_t_allegato "
			...
			+ " VALUES(nextval('bdom_t_allegato_allegato_id_seq'), :file_name, :file_type, :file_path, :sportello_id, :domanda_det_id, :domanda_det_cod, "
	...
	public static final String SELECT_DET_COD_ALLEGATO = "select count(*) from bdom_t_allegato a, bdom_d_allegato_tipo b "
	...
	public static final String SELECT_ALLEGATI = "select bta.file_path,bta.file_name,bta.allegato_id,bta.sportello_id,bta.allegato_tipo_id,bdat.allegato_tipo_cod,"
			+ " bdat.allegato_tipo_desc, bta.file_type " + " from bdom_t_allegato bta, bdom_d_allegato_tipo bdat  "
	...
	public static final String UPDATE_DETTAGLIO_DOMANDA_MESSAGEUUID = "update bdom_t_domanda_dettaglio "
			+ "set data_modifica=now(), utente_modifica='STARDUS_SMISTADOC', "
	...
	public static final String SELECT_DATA_CONTRODEDOTTA = "select to_char(max(btdd.validita_inizio),'dd/MM/yyyy') datacontrodedotta from "
			+ "bdom_t_domanda_dettaglio btdd , bdom_t_domanda btd , bdom_d_domanda_stato bdds "
	...
	public static final String SELECT_INCOMPATIBILITA_DOMANDA = "select nvl(btdd.incompatibilita_per_contratto,false) incompatibilita_per_contratto ,btdd.nessuna_incompatibilita "
			+ "from bdom_t_domanda_dettaglio btdd , bdom_t_domanda btd " + "where btdd.domanda_id = btd.domanda_id "
	...
	public static final String SELECT_NUMERO_RICHIESTA_RECUPERO_STARDAS_PARTENZA = "select btd.domanda_numero,btdd.domanda_det_id,btdd.note "
			...
			+ "	btdd.data_cancellazione is null  " + "	and  " + "	btdd.validita_inizio <= now() " + "	and "
			+ "	btdd.validita_fine is null   " + "	and  " + "	btdd.titolo_studio_id=bdts.titolo_studio_id  "
			+ "	and  " + "	btdd.asl_id = bda.asl_id " + " and bdds.domanda_stato_cod = :domanda_stato_cod "
