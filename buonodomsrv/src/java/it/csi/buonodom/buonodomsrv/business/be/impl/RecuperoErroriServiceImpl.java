...
import it.csi.buonodom.buonodomsrv.business.be.RecuperoErroriApi;
import it.csi.buonodom.buonodomsrv.business.be.service.RecuperoErroriService;
...
public class RecuperoErroriServiceImpl implements RecuperoErroriApi {
	...
	public Response recuperoErroriStardasPartenza(String tipolettera, String xRequestId, String xForwardedFor,
		...
		return recuperErrori.recuperoErroriStardasPartenza(tipolettera, xRequestId, xForwardedFor, xCodiceServizio,
