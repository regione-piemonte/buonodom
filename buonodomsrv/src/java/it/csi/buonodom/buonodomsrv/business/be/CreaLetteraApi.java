...
public interface CreaLetteraApi {
	...
	public Response GetCreaLettera(@PathParam("numero_richiesta") String numeroRichiesta,
			@PathParam("tipo_lettera") String tipoLettera, @HeaderParam("X-Request-Id") String xRequestId,
