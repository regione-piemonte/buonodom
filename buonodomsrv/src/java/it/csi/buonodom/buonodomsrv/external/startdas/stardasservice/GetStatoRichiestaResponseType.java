...
package it.csi.buonodom.buonodomsrv.external.startdas.stardasservice;
...
import it.csi.buonodom.buonodomsrv.external.startdas.services.stardascommontypes.ResponseType;
import it.csi.buonodom.buonodomsrv.external.startdas.services.stardascommontypes.StatoRichiestaType;
...
@XmlType(name = "GetStatoRichiestaResponseType", propOrder = { "statoRichiesta", "codiceEsitoRichiesta",
		"dettaglioEsitoRichiesta" })
public class GetStatoRichiestaResponseType extends ResponseType {
	 ...
	 * 
	 * @return possible object is {@link StatoRichiestaType }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link StatoRichiestaType }
	 * 
	 */
