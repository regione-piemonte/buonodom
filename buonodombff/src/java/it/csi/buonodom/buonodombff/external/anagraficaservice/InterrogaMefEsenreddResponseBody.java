...
******************************************************************************/
package it.csi.buonodom.buonodombff.external.anagraficaservice;
...
/**
 * <p>
 * Classe Java per InterrogaMefEsenreddResponseBody complex type.
 * 
 * <p>
...
@XmlType(name = "InterrogaMefEsenreddResponseBody", propOrder = { "capResidenza", "codicefiscale", "cognome",
		"comuneResidenza", "comunenasc", "datadecesso", "datanascita", "findType", "idComunenascita", "idStatonascita",
		"indirizzoResidenza", "nazionenasc", "nome", "provinciaResidenza", "provincianasc", "provnasc",
		"sceltaInDeroga", "sesso", "privacy" })
