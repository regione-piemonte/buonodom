...
public class AllegatoBuonoDao extends LoggerUtil {
	...
	public static final String SELECT_CF_RICHIEDENTE_FROM_ALLEGATO = "select btd.richiedente_cf  "
			...
			+ "	bdom_t_buono_allegato btba, bdom_r_contratto_allegato brca  " + "where  btba.allegato_id = :allegatoId "
	...
	public static final String SELECT_CF_RICHIEDENTE_NUMERO_DOMANDA = "select btd.richiedente_cf  "
			+ "from bdom_t_domanda btd " + "where btd.domanda_numero  = :numeroDomanda "
	...
	public static final String SELECT_BUONO_COD_FROM_NUMERO_DOMANDA = "select distinct btb.buono_cod from bdom_t_buono btb, bdom_r_buono_stato brbs,bdom_d_buono_stato bdbs , "
			...
			// + "and bdbs.buono_stato_cod =='ATTIVO' "
	...
	public static final String CHECK_ESISTENZA_ALLEGATO = "select count(*) " + "from bdom_t_buono_allegato btba "
	...
	public static final String SELECT_ALLEGATO = "select btba.file_name, btba.file_type as allegato_tipo_cod, btba.allegato_id  "
			+ "from bdom_t_buono_allegato btba  "
			+ "where btba.file_path like '%'||REPLACE(:filePath, '\\', '\\\\')||'%' "
			+ "and btba.allegato_tipo_id  = ( " + "	select bdbat.allegato_tipo_id  "
			+ "	from bdom_d_buono_allegato_tipo bdbat " + "	where bdbat.allegato_tipo_cod = :allegatoTipo "
			+ "	and bdbat.data_cancellazione is null " + ") " + "and btba.data_cancellazione is null;";

	public static final String UPDATE_CONTRATTO_ALLEGATO = "update buonodom.bdom_t_buono_allegato set  "
	...
	public static final String SELECT_ALLEGATO_BUONO_PERTIPO = "select btba.file_name , btba.file_path "
			+ "from bdom_t_buono_allegato btba,bdom_d_buono_allegato_tipo bdbat  where btba.allegato_id = :allegatoId "
