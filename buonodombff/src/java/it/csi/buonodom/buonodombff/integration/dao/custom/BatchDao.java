...
import it.csi.buonodom.buonodombff.integration.dao.utils.RichiesteBatchMapper;
...
public class BatchDao extends LoggerUtil {
	...
	public static final String SELECT_BATCH_PARAMETRO = "SELECT batchparam_valore "
			...
			+ "and b.batchgruppo_id=c.batchgruppo_id " + "and c.batchgruppo_cod='SERVIZIO_BFF'";
	...
	public static final String SELECT_NUMERO_TENTATIVI_OK = "select batchesec_tentativo_numero from bdom_s_batch_esecuzione a, bdom_d_batch_motivo b "
			...
			+ "and a.batch_id = (select batch_id from bdom_d_batch where batch_cod = :batchCod) "
	...
	public static final String SELECT_ESISTE_RECORD_AVVIATO_KO = "select batchesec_id from bdom_t_batch_esecuzione a, bdom_d_batch_stato b,"
			...
			+ "and d.batchgruppo_id =c.batchgruppo_id " + "and d.batchgruppo_cod ='SERVIZIO_BFF' "
			...
			+ "and b.validita_inizio  <= now() " + "and b.validita_fine is null " + "and c.batch_cod = :batch_cod "
	...
	public Long selectEsisteAvviatoKo(String batchesecstatoCod, ModelRichiestaBatch richiesta, String batchCod)
		...
		SqlParameterSource namedParameters = new MapSqlParameterSource()
				...
				.addValue("domanda_det_id", richiesta.getDomandaDetId()).addValue("batch_cod", batchCod);
		try {
