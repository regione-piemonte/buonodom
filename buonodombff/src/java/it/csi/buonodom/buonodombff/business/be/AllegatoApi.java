...
public interface AllegatoApi {
	...
	public Response allegatoNumeroRichiestaTipoAllegatoGet(@PathParam("tipo_allegato") String tipoAllegato,
			@PathParam("numero_richiesta") String numeroRichiesta, @HeaderParam("X-Forwarded-For") String xForwardedFor,
	...
	public Response allegatoNumeroRichiestaTipoAllegatoPost(@PathParam("tipo_allegato") String tipoAllegato,
