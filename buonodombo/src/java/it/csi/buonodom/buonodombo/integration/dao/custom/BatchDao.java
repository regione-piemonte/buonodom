...
import it.csi.buonodom.buonodombo.dto.custom.ModelRichiestaBatch;
import it.csi.buonodom.buonodombo.exception.DatabaseException;
import it.csi.buonodom.buonodombo.integration.dao.utils.RichiesteBatchMapper;
...
public class BatchDao extends LoggerUtil {
	...
	public static final String UPDATE_BATCH_ESECUZIONE_OK = "UPDATE bdom_s_batch_esecuzione SET "
			...
			+ "WHERE sportello_id = :sportello_id " + "and domanda_id = :domanda_id "
			+ "and domanda_det_id = :domanda_det_id " + "and batch_id = :batch_id "
			+ "and batchesecstato_id = :batchesecstato_id " + "and batchmotivo_id = :batchmotivo_id";
	...
	public static final String SELECT_STATO_BATCH = "SELECT batchesecstato_id FROM bdom_d_batch_stato "
			+ "where batchesecstato_cod = :batchesecstato_cod " + "and validita_fine is null "
			+ "and validita_inizio <= now() " + "and data_cancellazione is null";

	public static final String SELECT_MOTIVO_BATCH = "SELECT batchmotivo_id FROM bdom_d_batch_motivo "
			+ "where batchmotivo_cod = :batchmotivo_cod " + "and validita_fine is null "
			+ "and validita_inizio <= now() " + "and data_cancellazione is null";

	public static final String SELECT_BATCH = "SELECT batch_id FROM bdom_d_batch a,bdom_d_batch_gruppo b "
			+ "where a.batch_cod = :batch_cod " + "and a.validita_fine is null " + "and a.validita_inizio <= now() "
			...
			+ "and b.batchgruppo_cod='SERVIZIO_BO'";
	...
	public static final String SELECT_BATCH_PARAMETRO = "SELECT batchparam_valore "
			...
			+ "and b.batch_cod = :batch_cod " + "and batchparam_cod = :batchparam_cod " + "and a.validita_fine is null "
			...
			+ "and b.batchgruppo_id=c.batchgruppo_id " + "and c.batchgruppo_cod='SERVIZIO_BO'";
	...
	public static final String SELECT_NUMERO_TENTATIVI_OK = "select batchesec_tentativo_numero from bdom_s_batch_esecuzione a, bdom_d_batch_motivo b "
			...
			+ "and b.batchmotivo_id =a.batchmotivo_id " + "and b.batchmotivo_cod = :batchmotivo_cod "
	...
	public static final String SELECT_ESITO_POSITIVO = "select count(*) from bdom_s_batch_esecuzione a,bdom_s_batch_esecuzione_det b "
			...
			+ "and b.data_cancellazione is null " + "and b.batchesecdet_step = :batchesecdet_step";
	...
	public static final String SELECT_ESISTE_RECORD_AVVIATO_KO = "select batchesec_id from bdom_t_batch_esecuzione a, bdom_d_batch_stato b,"
			...
			+ "and b.batchesecstato_cod = :batchesecstato_cod " + "and c.batch_id = a.batch_id "
			+ "and d.batchgruppo_id =c.batchgruppo_id " + "and d.batchgruppo_cod ='SERVIZIO_BO' "
			+ "and a.sportello_id = :sportello_id " + "and a.domanda_id = :domanda_id "
			+ "and a.domanda_det_id = :domanda_det_id " + "and a.data_cancellazione is null "
	...
	public static final String SELECT_ESISTE_RECORD_KO = "select count(*) from bdom_t_batch_esecuzione a, bdom_t_batch_esecuzione_det b "
			+ "where a.batchesec_id = b.batchesec_id " + "and a.batchesec_id = :batchesec_id";
	...
	public static final String DELETE_RECORD_OK = "delete from bdom_s_batch_esecuzione "
			+ "where batchesec_id = :batchesec_id";

	public static final String DELETE_RECORD_KO = "delete from bdom_t_batch_esecuzione "
			+ "where batchesec_id = :batchesec_id";
	...
	public Integer selectEsitoPositivo(ModelRichiestaBatch richiesta, String batchesecdetStep)
		...
		SqlParameterSource namedParameters = new MapSqlParameterSource()
				.addValue("sportello_id", richiesta.getSportelloId()).addValue("domanda_id", richiesta.getDomandaId())
	...
	public Long selectEsisteAvviatoKo(String batchesecstatoCod, ModelRichiestaBatch richiesta)
			throws DatabaseException {

		SqlParameterSource namedParameters = new MapSqlParameterSource()
				.addValue("batchesecstato_cod", batchesecstatoCod).addValue("sportello_id", richiesta.getSportelloId())
	...
	public Long selectEsisteAvviatoOk(String batchesecstatoCod, ModelRichiestaBatch richiesta)
			throws DatabaseException {
	...
	public Integer selectNumeroTentativiKO(ModelRichiestaBatch richiesta, String batchmotivoCod)
			throws DatabaseException {
		Integer valorint = 0;
		SqlParameterSource namedParameters = new MapSqlParameterSource()
				.addValue("sportello_id", richiesta.getSportelloId()).addValue("domanda_id", richiesta.getDomandaId())
	...
	public Integer selectNumeroTentativiOK(ModelRichiestaBatch richiesta, String batchmotivoCod)
			throws DatabaseException {
		Integer valorint = 0;
		SqlParameterSource namedParameters = new MapSqlParameterSource()
				.addValue("sportello_id", richiesta.getSportelloId()).addValue("domanda_id", richiesta.getDomandaId())
	...
	public void UpdateBatchEsecuzioneOK(int tentativi, ModelRichiestaBatch datiDomanda, Long batchId, Long statoId,
		...
		SqlParameterSource namedParameters = new MapSqlParameterSource()
				...
				.addValue("domanda_det_id", datiDomanda.getDomandaDetId()).addValue("batch_id", batchId)
				.addValue("batchesecstato_id", statoId).addValue("batchmotivo_id", motivoId);
		try {
	...
	public long insertBatchEsecuzioneStepOK(String batchesecdetStep, String batchesecdetNote, Long batchesecId,
			Long batchesecstatoId, String utente) throws DatabaseException {
	...
	public long insertBatchEsecuzioneStepKO(String batchesecdetStep, String batchesecdetNote, Long batchesecId,
			Long batchesecstatoId, String utente) throws DatabaseException {
