...
public class ModelRichiestaContratto {
	...
	private String relazioneDestinatarioDesc = null;
	...
	@JsonProperty("relazione_destinatario_desc")

	public String getRelazioneDestinatarioDesc() {
		return relazioneDestinatarioDesc;
	}

	public void setRelazioneDestinatarioDesc(String relazioneDestinatarioDesc) {
		this.relazioneDestinatarioDesc = relazioneDestinatarioDesc;
	}
