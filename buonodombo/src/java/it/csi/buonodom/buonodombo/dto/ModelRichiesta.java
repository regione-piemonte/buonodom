...
public class ModelRichiesta {
	...
	private ModelRichiestaAccredito accredito = null;
	...
	@JsonProperty("ateco")
	public ModelAteco getAteco() {
		return ateco;
	}

	public void setAteco(ModelAteco ateco) {
		this.ateco = ateco;
	}
	...
	@JsonProperty("accredito")

	public ModelRichiestaAccredito getAccredito() {
		return accredito;
	}

	public void setAccredito(ModelRichiestaAccredito accredito) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(accredito, allegati, areaDesc, aslDestinatario, ateco, attestazioneIsee, contratto,
				contributoTipoDesc, dataAggiornamento, delegaCod, delegaDesc, destinatario, domandaStatoDesc,
				domicilioDestinatario, isee, lavoroDestinatario, nessunaIncompatibilita, note, noteInterna, numero,
				protocollo, punteggioBisognoSociale, rettificare, richiedente, stato, studioDestinatario,
				valutazioneMultidimensionale, verifiche);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(accredito, other.accredito) && Objects.equals(allegati, other.allegati)
				&& Objects.equals(areaDesc, other.areaDesc) && Objects.equals(aslDestinatario, other.aslDestinatario)
				&& Objects.equals(ateco, other.ateco) && Objects.equals(attestazioneIsee, other.attestazioneIsee)
				...
				&& Objects.equals(delegaCod, other.delegaCod)
				&& Objects.equals(dataAggiornamento, other.dataAggiornamento)
				&& Objects.equals(delegaDesc, other.delegaDesc) && Objects.equals(destinatario, other.destinatario)
	...
	public String toString() {
		...
		sb.append("    accredito: ").append(toIndentedString(accredito)).append("\n");
