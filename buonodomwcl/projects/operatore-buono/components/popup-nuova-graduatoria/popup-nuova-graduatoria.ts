...
import { ModelNuovaGraduatoria } from '@buonodom-app/app/dto/ModelNuovaGraduatoria';
import { Sportello } from '@buonodom-app/app/dto/Sportello';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { forkJoin } from 'rxjs';
import { DecimalPipe } from '@angular/common';
import { ModelArea } from '@buonodom-app/app/dto/ModelArea';
...
export class PopupNuovaGraduatoriaComponent implements OnInit {
  ...
  constructor(public client: BuonodomBOClient, private fb: FormBuilder, public activeModal: NgbActiveModal) { }
  //ON INIT
  ngOnInit() {
