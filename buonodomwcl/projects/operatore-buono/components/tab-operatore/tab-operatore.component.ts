...
export class TabOperatoreComponent implements OnInit {
  ...
  archivioGraduatorie = {
    title: 'Archivio Graduatorie',
    link: 'archivio-graduatorie',
    active: true
  }
  ...
  constructor(public route: ActivatedRoute, public client: BuonodomBOClient, private modalService: NgbModal, public toastService: AppToastService, private router: Router) {
  ...
  ngOnInit(): void {
    ...
    if (this.client.azioni.some((azione) => azione.codAzione === AZIONE.OP_ArchivioGraduatorie)) {
      this.links.push(this.archivioGraduatorie);
    }
