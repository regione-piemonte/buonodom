...
import { ModelRicercaBuono } from '@buonodom-app/app/dto/ModelRicercaBuono';
import { FiltriRicercaBuoni } from '@buonodom-app/app/dto/FiltriRicercaBuoni';
...
export class RendicontazioneOpComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  displayedColumns: string[] = ['numeroDomanda', 'destinatario', 'richiedente', 'statoBuono', 'dateDecorrenzaBuono', 'azione'];
  ...
  avviaRicerca() {
    ...
    const ricerca = new FiltriRicercaBuoni(statoBuono, numeroBuono, richiedente, destinatario, numeroDomanda);
