...
export class ContainerOperatoreComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, public client: BuonodomBOClient) {
  }
  ...
  backButton() {
    ...
    this.client.filtroDomandeAperte = new FiltriDomandeAperte(null, null, null, null, null, null,null,null, null, null, null);
