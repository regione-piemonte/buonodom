...
import { AZIONE, STATO_GRADUATORIA } from '@buonodom-app/constants/buonodom-constants';
import { Sportello } from '@buonodom-app/app/dto/Sportello';
import { ModelCriteriGraduatoria } from '@buonodom-app/app/dto/ModelCriteriGraduatoria';
...
export class GraduatoriaComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(private modalService: NgbModal, public client: BuonodomBOClient, public appToastService: AppToastService, private dialog: MatDialog, private excelService: ExcelService) { }
  ...
  */
  ...
  scaricaGraduatoria() {
    ...
    nomeFile = nomeFile + '_' + this.client.graduatoriaDescrizione.codiceGraduatoria.trim();
