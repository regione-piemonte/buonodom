...
import { ALLEGATI, AZIONE, CONTRATTO, DATIENTE_INFO, DOC, ERRORS, MSG, PATTERN, SECTION, STATO_DOMANDA, STATO_ENTE, STATO_ENTE_DESC_LUNGA, TIPO_FEEDBACK, VALUTAZIONE } from '@buonodom-app/constants/buonodom-constants';
import { animate, state, style, transition, trigger } from '@angular/animations';
import { GenericResponseWarnErrBuonodom } from '@buonodom-app/app/dto/GenericResponseWarnErrBuonodom';
...
import { ModelDownloadAllegato } from '@buonodom-app/app/dto/ModelDownloadAllegato';
import { ModelAteco } from '@buonodom-app/app/dto/ModelAteco';
...
import { PresaInCaricoModel } from '@buonodom-app/app/dto/PresaInCaricoModel';
import { ModelMessaggio } from '@buonodom-app/app/dto/ModelMessaggio';
import { CronologiaComponent } from '../cronologia/cronologia.component';
import { ModelIsee } from '@buonodom-app/app/dto/ModelIsee';
...
export class DatiIstanzaComponent implements OnInit {
  ...
  checkAzione(azione: string): boolean {
    ...
    switch (azione) {
      ...
      case "verifica_ateco":
        return this.client.azioni.some(a => a.codAzione == AZIONE.OP_VerificaATECO);
      case "verifica_isee":
  ...
  abilitabottoni() {
    ...
    if (this.domanda != null && this.domanda != undefined && (this.domanda.stato === STATO_DOMANDA.CONTRODEDOTTA || this.domanda.stato === STATO_DOMANDA.AMMISSIBILE) && !incompatibilita) {
