...
import { Sportelli } from '@buonodom-app/app/dto/Sportelli';
...
export class PopupNuovoSportelloComponent implements OnInit {
  ...
  constructor(private client: BuonodomBOClient, private fb: FormBuilder, public activeModal: NgbActiveModal, public toastService: AppToastService) { }
  //ON INIT
  ngOnInit() {
