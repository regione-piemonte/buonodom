...
******************************************************************************/
package it.csi.buonodom.buonodombanbatch.integration.rest;
...
public class RestBaseService extends BatchLoggerFactory {
	...
	private String buonodombandisrvusername = Configuration.get("buonodombandisrvusername");
	private String buonodomvbandisrvpassword = Configuration.get("buonodombandisrvpassword");
	private String buonodombandisrvurl = Configuration.get("buonodombandisrvurl");
	...
	public static RestBaseService getInstance(BuonodombanBatchDAO dao) {
		if (instance == null) {
	...
	private OkHttpClient getHttpClientBandi() {
		if (okHttpClient == null) {
			okHttpClient = new OkHttpClient.Builder().connectTimeout(45, TimeUnit.SECONDS)
					.writeTimeout(45, TimeUnit.SECONDS).readTimeout(45, TimeUnit.SECONDS)
					.addInterceptor(
							new BasicAuthInterceptor(this.buonodombandisrvusername, this.buonodomvbandisrvpassword))
					.build();
		}
	...
	private OkHttpClient getHttpClientLocalBandi() {
		if (okHttpClient == null) {
			okHttpClient = new OkHttpClient.Builder().connectTimeout(45, TimeUnit.SECONDS)
					.writeTimeout(45, TimeUnit.SECONDS).readTimeout(45, TimeUnit.SECONDS)
					.addInterceptor(
...
//    }
	...
	public String getBuonodombandisrvusername() {
		return buonodombandisrvusername;
	}

	public void setBuonodombandisrvusername(String buonodombandisrvusername) {
		this.buonodombandisrvusername = buonodombandisrvusername;
	}

	public String getBuonodomvbandisrvpassword() {
		return buonodomvbandisrvpassword;
	}

	public void setBuonodomvbandisrvpassword(String buonodomvbandisrvpassword) {
		this.buonodomvbandisrvpassword = buonodomvbandisrvpassword;
	}

	public String getBuonodombandisrvurl() {
		return buonodombandisrvurl;
	}

	public void setBuonodombandisrvurl(String buonodombandisrvurl) {
		this.buonodombandisrvurl = buonodombandisrvurl;
	}
