...
@XmlType(propOrder = { "codTipoUtente", "tipoUtente", "tipologiaEnte", "codiceDipartimento", "descrizioneDipartimento",
		"formaGiuridicaImpresa", "codFormaGiuridica", "codiceFiscaleImpresa", "ragioneSocialeImpresa",
		"partitaivaSedelegale", "codiceAteco", "statoSedelegale", "codStatoSedelegale", "tipologiaRegistroIscrizione",
		"iscrizioneIncorso", "cin", "abi", "cab", "iban", "bic", "nContocorrente", "ruoloBeneficiario",
		"classificazioneEnte", "cognomePersonaFisica", "nomePersonaFisica", "statoNascitaPersonaFisica",
		"provinciaNascitaPersonaFisica", "provinciaNascitaDescrizionePersonaFisica", "codiceComuneNascitaPersonaFisica",
		"comuneNascitaPersonaFisica", "statoEsteroNascitaPersonaFisica", "dataNascitaPersonaFisica",
		"codiceComuneSedelegale", "comuneSedelegale", "indirizzoSedelegale", "capSedelegale", "telefonoSedelegale",
		"emailSedelegale", "pecSedelegale" })
