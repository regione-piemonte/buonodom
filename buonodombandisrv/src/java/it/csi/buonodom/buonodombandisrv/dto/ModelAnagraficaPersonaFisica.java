...
@XmlType(propOrder = { "codiceFiscaleImpresa", "tipoPersonaFisica", "codiceFiscaleSoggetto", "cognome", "nome",
		"dataNascita", "statoNascita", "codiceComuneNascita", "comuneNascita", "statoIndirizzo", "codStatoIndirizzo",
		"codiceComuneIndirizzo", "comuneIndirizzo", "capIndirizzo", "indirizzo" })
