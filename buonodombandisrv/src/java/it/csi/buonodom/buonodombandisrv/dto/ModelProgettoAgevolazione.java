...
@XmlType(propOrder = { "dataPresentazione", "oraPresentazione", "partitaivaUnitalocale", "sedeNonAttivataInPiemonte",
		"codiceAteco", "descrizioneAttivitaUnitalocale", "codiceSettoreUnitalocale", "descrizioneSettoreUnitalocale",
		"statoUnitalocale", "codStatoUnitalocale", "capUnitalocale", "codiceComuneUnitalocale", "comuneUnitalocale",
		"provinciaUnitalocale", "modalitaRegistrazione", "indirizzoUnitalocale", "titoloProgetto",
		"descrizioneProgetto", "abstractProgetto", "contributoRichiesto", "finanziamentoRichiesto", "spesaAmmessa",
		"finanziamentoBancario", "codSportello", "codAreaTerritoriale" })
