...
public class ModelRichiestaContratto {
	...
	@Override
	public int hashCode() {
		return Objects.hash(tipo, intestatario, relazioneDestinatario, assistenteFamiliare, agenzia,
				incompatibilitaPerContratto, assistenteFamiliare, pivaAssitenteFamiliare);
	}
