...
public class ModelDocumentoSpesa {
	...
	private String fornitoreCf = null;
	...
	@JsonProperty("fornitore_cf")

	public String getFornitoreCf() {
		return fornitoreCf;
	}

	public void setFornitoreCf(String fornitoreCf) {
		this.fornitoreCf = fornitoreCf;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(dettagli, dicSpesaCod, fornitoreCf, id, idFornitore, mesi, note, numero, stato, tipologia);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(dettagli, other.dettagli) && Objects.equals(dicSpesaCod, other.dicSpesaCod)
				&& Objects.equals(fornitoreCf, other.fornitoreCf) && Objects.equals(id, other.id)
